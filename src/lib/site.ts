...
export const COPY: Record<Lang, {
  ...
  en: {
    ...
    homeTitle: 'Notes on personal productivity systems.',
    homeIntro: 'A working notebook on focused work, AI-assisted execution, connected notes, goals, and the daily operating system behind integ.life.',
    homeSecondary: 'Practical essays, product notes, and workflow experiments from Albert.',
